        ...
        <div className='mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2'>
            <div className='flex flex-col'>
                ...
                <Typography type='copy'>
                    Not looking for any new roles at the moment!!! Happy where I am right now.
                </Typography>
                <Typography type='copy'>
                ...
                <Typography type='copy'>
                    <ul className='list-disc list-outside pl-5 leading-7'>
                        ...
                        <li>
                            6+ months of <strong>WordPress + SEO</strong> experience
                        </li>
                        <li>
                ...
                <div className='rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40'>
                    ...
                    <ol className='mt-6 space-y-4'>
                        ...
                        <li className='flex gap-4'>
                            <div className='relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md ring-1 shadow-zinc-800/5 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0'>
                                <Image
                                    src='/images/cognizant_logo.jpeg'
                                    alt=''
                                    loading='lazy'
                                    width='28'
                                    height='28'
                            ...
                            <dl className='flex flex-auto flex-wrap gap-x-2'>
                                ...
                                <dd
                                    ...
                                    <time dateTime='2009'>2009</time> <span aria-hidden='true'>-</span>{' '}
                    ...
                    <ol className='mt-6 space-y-4'>
                        <li className='flex gap-4'>
                            ...
                            <dl className='flex flex-auto flex-wrap gap-x-2'>
                                ...
                                <dd
                                    className='ml-auto text-xs text-zinc-400 dark:text-zinc-500'
                                    aria-label='2006 until 2009'>
                                    <time dateTime='2006'>2006</time> <span aria-hidden='true'>-</span>{' '}
                        ...
                        <li className='flex gap-4'>
                            ...
                            <dl className='flex flex-auto flex-wrap gap-x-2'>
                                ...
                                <dd
                                    className='ml-auto text-xs text-zinc-400 dark:text-zinc-500'
                                    aria-label='2003 until 2006'>
                                    <time dateTime='2003'>2003</time> <span aria-hidden='true'>-</span>{' '}
