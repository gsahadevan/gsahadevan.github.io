    ...
    return (
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
            ...
            <div className="lg:order-first lg:row-span-2">
                ...
                <Typography type='title'>I am Gauthaman Sahadevan</Typography>
            ...
            <div className="lg:pl-20">
                <ul role="list">
                    <li className="mt-4 flex border-t border-zinc-100 pt-8 dark:border-zinc-700/40 ">
                        <Link className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500 items-center"
