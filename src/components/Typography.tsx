...
export const Typography = ({
    ...
    switch (type) {
        ...
        case 'heading':
            return <div className='mt-6 text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100'>{children}</div>;
        case 'overline':
        ...
        case 'title':
            return <div className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">{children}</div>;
        default:
            return <>{children}</>;
    };
}
